...
int main() 
{
	...
	//HERE WE DID NOT SEND ANY ARGUMENT TO THE FUNCTION FUNC BUT ASLINDA ASSEMBLY KODUNA BAKARSAK FONKSIYONA RETURN DEÐERININ AKTARILACAÐI YERIN DE ADRESI GONDERILIYOR BUNA RETURN SLOT  DENIYOR
